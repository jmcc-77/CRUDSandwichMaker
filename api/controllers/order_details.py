...
def update(db: Session, order_detail_id, order_detail: schemas.OrderDetailUpdate):
    db_query = db.query(models.OrderDetail).filter(models.OrderDetail.id == order_detail_id)
...
def delete(db: Session, order_detail_id):
    db_query = db.query(models.OrderDetail).filter(models.Order.id == order_detail_id)
